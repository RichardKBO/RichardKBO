...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=F74C00&center=true&vCenter=true&width=600&lines=Ol%C3%A1%2C+eu+sou+Richard+Kawan+%F0%9F%91%8B;Engenharia+de+Computa%C3%A7%C3%A3o+%40+UEMG;Focado+em+C%2B%2B%2C+Rust+e+POO" alt="Typing"/>
</p>
...
`C++23` `POO` `Herança` `Polimorfismo` `unique_ptr` `STL` `CMake` `Validação de CPF`
